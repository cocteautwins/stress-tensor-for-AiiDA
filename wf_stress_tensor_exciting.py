...
class Workflow_LAPW_stress_tensor(Workflow):
    def __init__(self, **kwargs):

        super(Workflow_LAPW_stress_tensor, self).__init__(**kwargs)
    ...
    def get_distorted_structure(self, structure_id, M_eps):
        ...
        distorted_cell = np.dot(M_eps, s0.cell)
    ...
    def stress_tensor(self):
        ...
        for ii in distorted_structure_index:
            ...
            distorted_structure = self.get_distorted_structure(structure_id=structure_id, M_eps=M_eps)
