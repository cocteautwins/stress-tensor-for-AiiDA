...
## ===============================================
##    Workflow_PW_Stress_Tensor_SLagrange
## ===============================================

class Workflow_PW_stress_tensor_SLagrange(Workflow):
    def __init__(self, **kwargs):

        super(Workflow_PW_stress_tensor_SLagrange, self).__init__(**kwargs)
    ...
    def get_SLagrange_distorted_structure(self, structure_id, M_SLagrange_eps):
        ...
        #distorted_cell = np.dot(M_SLagrange_eps, s0.cell)
        distorted_cell = np.dot(s0.cell, M_SLagrange_eps)
    ...
    def stress_tensor(self):
        ...
        for ii in distorted_structure_index:
            ...
            M_SLagrange_eps = self.get_SLagrange_strain_matrix(eps=a, def_mtx_index=i)

            distorted_structure = self.get_SLagrange_distorted_structure(structure_id=structure_id, M_SLagrange_eps=M_SLagrange_eps)
            ...
            self.append_to_report("Distorted structure with index {0} has ID {1}".format(eps_index, distorted_structure.id))
