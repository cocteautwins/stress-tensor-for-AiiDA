...
class Workflow_LAPW_stress_tensor_SLagrange(Workflow):
    def __init__(self, **kwargs):

        super(Workflow_LAPW_stress_tensor_SLagrange, self).__init__(**kwargs)
    ...
    def get_Lagrange_distorted_structure(self, structure_id, M_SLagrange_eps):
    ...
    def stress_tensor(self):
        ...
        for i in def_list:
            for a in eps:
                ...
                distorted_structure = self.get_Lagrange_distorted_structure(structure_id=structure_id, M_SLagrange_eps=M_SLagrange_eps)
