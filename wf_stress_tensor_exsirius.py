...
class Workflow_ExSIRIUS_stress_tensor(Workflow):
    def __init__(self, **kwargs):

        super(Workflow_ExSIRIUS_stress_tensor, self).__init__(**kwargs)
    ...
    ## ===============================================
#    def fitfunc(self, x, p): # model $f(x)=a x^3 + b x^2 + c x + d
#         a,b,c,d=p
#         return d+c*x+b*x**2+a*x**3
#
#    def residuals(self, p): # array of residuals
    ...
    def stress_tensor(self):
        ...
        for i in def_list:
            for a in eps:
                ...
                calc = self.get_lapw_calculation(self.get_distorted_structure(structure_id=structure_id, M_eps=M_eps),
